								...
								<form class="forms-sample" method="POST" action="{{ route('admin.update.password') }}">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
                                            ...
                                            @enderror" name="old_password" placeholder="Old Password">
										...
										<div class="col-sm-9">
                                            ...
                                            @enderror" name="new_password" placeholder="New Password">
										...
										<div class="col-sm-9">
											<input type="password" class="form-control @error('Confirm_new_password')
                                                
                                            @enderror" name="Confirm_new_password" placeholder="Confirm New Password">
