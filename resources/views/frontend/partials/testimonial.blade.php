                     ...
                     <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item">
                           <div class="top-area d-flex flex-wrap justify-content-between">
                              <div class="logo-box">
                                 <img src="{{ asset('frontend/assets/img/testimonials/logo/1.png')}}  alt="" />
                              </div>
                              <div class="image-box">
                                 <img src="{{ asset('frontend/assets/img/testimonials/user/1.jpg') }}" alt="" />
                              </div>
                           </div>
                           <div class="icon-box">
                        ...
                        <div class="testimonial-item">
                           <div class="top-area d-flex flex-wrap justify-content-between">
                              <div class="logo-box">
                                 <img src="{{ asset('frontend/assets/img/testimonials/logo/2.png') }}" alt="" />
                              </div>
                              <div class="image-box">
                                 <img src="{{ asset('frontend/assets/img/testimonials/user/2.jpg') }}" alt="" />
                              </div>
                           </div>
                           <div class="icon-box">
                              <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
